...
type MatchRequest struct {
	...
	StudyMode         string           `protobuf:"bytes,5,opt,name=study_mode,json=studyMode,proto3" json:"study_mode,omitempty"`
	...
	StudyStyle        string           `protobuf:"bytes,8,opt,name=study_style,json=studyStyle,proto3" json:"study_style,omitempty"`
	...
	DesiredTime       string           `protobuf:"bytes,11,opt,name=desired_time,json=desiredTime,proto3" json:"desired_time,omitempty"`
	TimeFlexMinutes   int32            `protobuf:"varint,12,opt,name=time_flex_minutes,json=timeFlexMinutes,proto3" json:"time_flex_minutes,omitempty"`
	PriorityWeights   map[string]int32 `protobuf:"bytes,13,rep,name=priority_weights,json=priorityWeights,proto3" json:"priority_weights,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
func (x *MatchRequest) GetStudyMode() string {
	if x != nil {
		return x.StudyMode
	}
	return ""
...
func (x *MatchRequest) GetCommunication() string {
	if x != nil {
...
func (x *MatchRequest) GetPriorityWeights() map[string]int32 {
	if x != nil {
...
type MatchResponse struct {
	...
	MatchedUserId int64                  `protobuf:"varint,4,opt,name=matched_user_id,json=matchedUserId,proto3" json:"matched_user_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MatchResponse) GetMatchedUserId() int64 {
	if x != nil {
...
const file_proto_matchmaking_proto_rawDesc = "" +
	"\n" +
	"\x17proto/matchmaking.proto\x12\vmatchmaking\"\xb2\x04\n" +
	...
	"\n" +
	"study_mode\x18\x05 \x01(\tR\tstudyMode\x12\x1d\n" +
	"\n" +
	"group_size\x18\x06 \x01(\x05R\tgroupSize\x12$\n" +
	"\rcommunication\x18\a \x01(\tR\rcommunication\x12\x1f\n" +
	"\vstudy_style\x18\b \x01(\tR\n" +
	"studyStyle\x12-\n" +
	"\x12preferred_language\x18\t \x01(\tR\x11preferredLanguage\x12\x1a\n" +
	"\btimezone\x18\n" +
	" \x01(\tR\btimezone\x12!\n" +
	"\fdesired_time\x18\v \x01(\tR\vdesiredTime\x12*\n" +
	"\x11time_flex_minutes\x18\f \x01(\x05R\x0ftimeFlexMinutes\x12Y\n" +
	"\x10priority_weights\x18\r \x03(\v2..matchmaking.MatchRequest.PriorityWeightsEntryR\x0fpriorityWeights\x1aB\n" +
	...
	"\x0fmatched_user_id\x18\x04 \x01(\x03R\rmatchedUserId2[\n" +
	"\x12MatchmakingService\x12E\n" +
	"\fRequestMatch\x12\x19.matchmaking.MatchRequest\x1a\x1a.matchmaking.MatchResponseB\x18Z\x16internal/matchmakingpbb\x06proto3"
...
var file_proto_matchmaking_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_matchmaking_proto_goTypes = []any{
	...
	nil,                   // 2: matchmaking.MatchRequest.PriorityWeightsEntry
}
var file_proto_matchmaking_proto_depIdxs = []int32{
	2, // 0: matchmaking.MatchRequest.priority_weights:type_name -> matchmaking.MatchRequest.PriorityWeightsEntry
	0, // 1: matchmaking.MatchmakingService.RequestMatch:input_type -> matchmaking.MatchRequest
	1, // 2: matchmaking.MatchmakingService.RequestMatch:output_type -> matchmaking.MatchResponse
