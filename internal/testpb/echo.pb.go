...
const file_echo_proto_rawDesc = "" +
	...
	"\x04Echo\x120\n" +
	"\bSayHello\x12\x12.test.HelloRequest\x1a\x10.test.HelloReplyBEZCstudysync-matchmaking-engine/internal/testpbb\x06proto3"
...
var file_echo_proto_goTypes = []any{
	...
	(*HelloReply)(nil),   // 1: test.HelloReply
}
var file_echo_proto_depIdxs = []int32{
	0, // 0: test.Echo.SayHello:input_type -> test.HelloRequest
	1, // 1: test.Echo.SayHello:output_type -> test.HelloReply
